...
namespace BL
{
    ...
    public class BL: IBL.IBL
    {
        ...
        public void Assignement(int ID)
        {
            ...
            {
                throw new IBL.BO.IDNotFound("ID was not found", ex);
            }
            ...
            {
                throw new IBL.BO.IDNotFound("The id was not found", ex);
            }
            if (flag == false) // we didn't find one
                throw new IBL.BO.NotFound("We didn't find a parcel");
            ...
            {
                throw new IBL.BO.IDNotFound("The parcel or the drone doesnt exist", ex);
            }
